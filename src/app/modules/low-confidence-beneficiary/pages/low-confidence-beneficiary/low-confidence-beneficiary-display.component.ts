...
@Component({
  selector: 'app-low-confidence-beneficiary-display',
  templateUrl: './low-confidence-beneficiary-display.component.html',
  styleUrls: ['./low-confidence-beneficiary-display.component.scss']
})
export class LowConfidenceBeneficiaryDisplayComponent implements OnInit {
