...
@Component({
  selector: 'app-high-confidence-beneficiary-display',
  templateUrl: './high-confidence-beneficiary-display.component.html',
  styleUrls: ['./high-confidence-beneficiary-display.component.scss']
})
export class HighConfidenceBeneficiaryDisplayComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.resultsCheckingForm = this.formBuilder.group({
      ...
      failReasons: ['', Validators.required]
    });
